...
enum KISO_TESTING_Retcodes_E
{
    ...
    TEST_RETCODE_TEST_CASE_ALREADY_REGISTERED,
    TEST_RETCODE_CCHANNEL_INITIALISATION_FAILED,
    TEST_RETCODE_INCOMPLETE_MESSAGE_RECEIVED,
    TEST_RETCODE_CRC_MISMATCH,
    TEST_RETCODE_VERSION_MISMATCH,
    TEST_RETCODE_TLVELEMENT_NOT_FOUND,
    TEST_RETCODE_REPORT_TIMEOUT,
    TEST_RETCODE_CCHANNEL_NOT_SPECIFIED,
};
