...
#ifndef CELLULAR_AT_RESPONSE_PARSER_H
#define CELLULAR_AT_RESPONSE_PARSER_H
...
typedef enum
{
	AT_RESPONSE_PARSER_NOT_INITIALIZED = RETCODE_CELLULAR_LAST_CUSTOM_CODE,//!< AT_RESPONSE_PARSER_NOT_INITIALIZED
	AT_RESPONSE_PARSER_INPUT_TOO_SHORT,                                 //!< AT_RESPONSE_PARSER_INPUT_TOO_SHORT
	AT_RESPONSE_PARSER_PARSE_ERROR,                                     //!< AT_RESPONSE_PARSER_PARSE_ERROR

	AT_RESPONSE_PARSER_LAST_CUSTOM_CODE                                 //!< AT_RESPONSE_PARSER_LAST_CUSTOM_CODE
...
#endif /* CELLULAR_AT_RESPONSE_PARSER_H */
