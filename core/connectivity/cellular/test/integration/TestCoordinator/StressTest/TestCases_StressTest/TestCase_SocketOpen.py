...
class TestCase_SocketOpen(unittest.TestCase):

    testCaseId = 7

    def __init__(self, testSection, testSuite):
        super(TestCase_SocketOpen, self).__init__()
    ...
    def setUp(self):
        print("====================================")
        print("setUp: TC_1.7.7-TestCase_SocketOpen ")
        print("====================================")
        ...
        ack = self.TP1.sendAndWaitForAck(message, 230)
        self.assertEqual(NO_ERROR, ack.getErrorCode(), "we don't expect any error code")

    def runTest(self):
        print("==================================")
        print("Run: TC_1.7.7-TestCase_SocketOpen ")
        print("==================================")
    ...
    def tearDown(self):
        print("=======================================")
        print("TearDown: TC_1.7.7-TestCase_SocketOpen ")
        print("=======================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
