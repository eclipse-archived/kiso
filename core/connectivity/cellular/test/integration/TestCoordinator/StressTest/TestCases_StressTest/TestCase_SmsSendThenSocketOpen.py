...
class TestCase_SmsSendThenSocketOpen(unittest.TestCase):

    testCaseId = 12

    def __init__(self, testSection, testSuite):
        super(TestCase_SmsSendThenSocketOpen, self).__init__()
    ...
    def setUp(self):
        print("==============================================")
        print("setUp: TC_1.7.12-TestCase_SmsSendThenSocketOpen ")
        print("==============================================")
    ...
    def runTest(self):
        print("============================================")
        print("Run: TC_1.7.12-TestCase_SmsSendThenSocketOpen ")
        print("============================================")
    ...
    def tearDown(self):
        print("=================================================")
        print("TearDown: TC_1.7.12-TestCase_SmsSendThenSocketOpen ")
        print("=================================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
