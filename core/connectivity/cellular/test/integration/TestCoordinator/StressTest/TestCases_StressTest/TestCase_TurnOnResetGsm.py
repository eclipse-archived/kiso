...
class TestCase_TurnOnResetCellular(unittest.TestCase):

    testCaseId = 2

    def __init__(self, testSection, testSuite):
        super(TestCase_TurnOnResetCellular, self).__init__()
    ...
    def setUp(self):
        print("========================================")
        print("setUp: TC_1.7.2-TestCase_TurnOnResetCellular ")
        print("========================================")
    ...
    def runTest(self):
        print("======================================")
        print("Run: TC_1.7.2-TestCase_TurnOnResetCellular ")
        print("======================================")
        ...
        ack = self.TP1.sendAndWaitForAck(messageTP1, 20)
        self.assertEqual(NO_ERROR, ack.getErrorCode(), "we don't expect any error code")
    ...
    def tearDown(self):
        print("===========================================")
        print("TearDown: TC_1.7.2-TestCase_TurnOnResetCellular ")
        print("===========================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
