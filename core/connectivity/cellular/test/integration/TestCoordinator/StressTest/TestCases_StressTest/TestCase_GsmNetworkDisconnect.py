...
class TestCase_CellularNetworkDisconnect(unittest.TestCase):

    testCaseId = 6

    def __init__(self, testSection, testSuite):
        super(TestCase_CellularNetworkDisconnect, self).__init__()
    ...
    def setUp(self):
        print("==============================================")
        print("setUp: TC_1.7.6-TestCase_CellularNetworkDisconnect ")
        print("==============================================")
    ...
    def runTest(self):
        print("============================================")
        print("Run: TC_1.7.6-TestCase_CellularNetworkDisconnect ")
        print("============================================")
    ...
    def tearDown(self):
        print("=================================================")
        print("TearDown: TC_1.7.6-TestCase_CellularNetworkDisconnect ")
        print("=================================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
