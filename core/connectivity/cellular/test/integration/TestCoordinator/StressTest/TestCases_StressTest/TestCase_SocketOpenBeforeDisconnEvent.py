...
class TestCase_SocketOpenBeforeDisconnEvent(unittest.TestCase):

    testCaseId = 10

    def __init__(self, testSection, testSuite):
        super(TestCase_SocketOpenBeforeDisconnEvent, self).__init__()
    ...
    def setUp(self):
        print("==============================================")
        print("setUp: TC_1.7.10-TestCase_SocketOpenBeforeDisconnEvent ")
        print("==============================================")
    ...
    def runTest(self):
        print("============================================")
        print("Run: TC_1.7.10-TestCase_SocketOpenBeforeDisconnEvent ")
        print("============================================")
    ...
    def tearDown(self):
        print("=================================================")
        print("TearDown: TC_1.7.10-TestCase_SocketOpenBeforeDisconnEvent ")
        print("=================================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
