...
class TestCase_SMSSendContinuously(unittest.TestCase):

    testCaseId = 11

    def __init__(self, testSection, testSuite):
        super(TestCase_SMSSendContinuously, self).__init__()
    ...
    def setUp(self):
        print("==============================================")
        print("setUp: TC_1.7.11-TestCase_SMSSendContinuously ")
        print("==============================================")
    ...
    def runTest(self):
        print("============================================")
        print("Run: TC_1.7.11-TestCase_SMSSendContinuously ")
        print("============================================")
        ...
        result = self.testSection.waitForReports([self.TP1], 500)
    ...
    def tearDown(self):
        print("=================================================")
        print("TearDown: TC_1.7.11-TestCase_SMSSendContinuously ")
        print("=================================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
