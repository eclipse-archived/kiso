...
class TestCase_TurnOnOffCellular(unittest.TestCase):

    testCaseId = 1

    def __init__(self, testSection, testSuite):
        super(TestCase_TurnOnOffCellular, self).__init__()
    ...
    def setUp(self):
        print("==============================")
        print("setUp: TestCase_TurnOnOffCellular ")
        print("==============================")
    ...
    def runTest(self):
        print("==============================")
        print("Run: TestCase_TurnOnOffCellular ")
        print("==============================")
    ...
    def tearDown(self):
        print("==============================")
        print("TearDown: TestCase_TurnOnOffCellular ")
        print("==============================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
