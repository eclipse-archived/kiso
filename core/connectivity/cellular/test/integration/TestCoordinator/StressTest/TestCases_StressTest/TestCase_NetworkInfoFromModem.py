...
class TestCase_NetworkInfoFromModem(unittest.TestCase):

    testCaseId = 4

    def __init__(self, testSection, testSuite):
        super(TestCase_NetworkInfoFromModem, self).__init__()
    ...
    def setUp(self):
        print("==============================================")
        print("setUp: TC_1.7.4-TestCase_NetworkInfoFromModem ")
        print("==============================================")
    ...
    def runTest(self):
        print("============================================")
        print("Run: TC_1.7.4-TestCase_NetworkInfoFromModem ")
        print("============================================")
    ...
    def tearDown(self):
        print("=================================================")
        print("TearDown: TC_1.7.4-TestCase_NetworkInfoFromModem ")
        print("=================================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
