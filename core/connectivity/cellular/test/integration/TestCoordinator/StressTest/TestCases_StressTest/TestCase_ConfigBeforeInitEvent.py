...
class TestCase_ConfigBeforeInitEvent(unittest.TestCase):

    testCaseId = 8

    def __init__(self, testSection, testSuite):
        super(TestCase_ConfigBeforeInitEvent, self).__init__()
    ...
    def setUp(self):
        print("==============================================")
        print("setUp: TC_1.7.8-TestCase_ConfigBeforeInitEvent ")
        print("==============================================")
    ...
    def runTest(self):
        print("============================================")
        print("Run: TC_1.7.8-TestCase_ConfigBeforeInitEvent ")
        print("============================================")
    ...
    def tearDown(self):
        print("=================================================")
        print("TearDown: TC_1.7.8-TestCase_ConfigBeforeInitEvent ")
        print("=================================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
