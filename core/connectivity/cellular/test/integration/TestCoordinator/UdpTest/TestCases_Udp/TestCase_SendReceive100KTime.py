...
class TestCase_SendReceive100KTime(unittest.TestCase):
    ...
    def __init__(self, testSection, testSuite):
        super(TestCase_SendReceive100KTime , self).__init__()
    ...
    def setUp(self):
        print("==============================================")
        print("setUp: TC_1.8.5-TestCase_SendReceive100KTime  ")
        print("==============================================")
    ...
    def runTest(self):
        print("============================================")
        print("Run: TC_1.8.5-TestCase_SendReceive100KTime  ")
        print("============================================")
        ...
        result = self.testSection.waitForReports([self.TP1], 3700)
    ...
    def tearDown(self):
        print("=================================================")
        print("TearDown: TC_1.8.5-TestCase_SendReceive100KTime  ")
        print("=================================================")
