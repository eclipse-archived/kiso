...
class TestCase_SendExceedDataLength (unittest.TestCase):
    ...
    def __init__(self, testSection, testSuite):
        super(TestCase_SendExceedDataLength , self).__init__()
    ...
    def setUp(self):
        print("===============================================")
        print("setUp: TC_1.8.7-TestCase_SendExceedDataLength  ")
        print("===============================================")
    ...
    def runTest(self):
        print("=============================================")
        print("Run: TC_1.8.7-TestCase_SendExceedDataLength  ")
        print("=============================================")
    ...
    def tearDown(self):
        print("==================================================")
        print("TearDown: TC_1.8.7-TestCase_SendExceedDataLength  ")
        print("==================================================")
