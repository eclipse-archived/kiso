...
class TestCase_SocketReceiveAfter30SecDelay(unittest.TestCase):
    ...
    def __init__(self, testSection, testSuite):
        super(TestCase_SocketReceiveAfter30SecDelay, self).__init__()
    ...
    def setUp(self):
        print("======================================================")
        print("setUp: TC_1.8.3-TestCase_SocketReceiveAfter30SecDelay ")
        print("======================================================")
    ...
    def runTest(self):
        print("====================================================")
        print("Run: TC_1.8.3-TestCase_SocketReceiveAfter30SecDelay ")
        print("====================================================")
        ...
        #Send UDP data to DUT after 30 sec
        self.udpTests.waitAndSendUdpData(30,"COSP_RX after delay of 30 sec")

        result = self.testSection.waitForReports([self.TP1], 60)
        ...
        if(NO_ERROR == report1.getErrorCode()):
            print("After 30 sec of delay, the data sent by server is received by device")

    def tearDown(self):
        print("=========================================================")
        print("TearDown: TC_1.8.3-TestCase_SocketReceiveAfter30SecDelay ")
        print("=========================================================")
