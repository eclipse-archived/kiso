...
class TestCase_ThreeSocketsOpenSend1KTime(unittest.TestCase):
    ...
    def __init__(self, testSection, testSuite):
        super(TestCase_ThreeSocketsOpenSend1KTime , self).__init__()
    ...
    def setUp(self):
        print("===================================================")
        print("setUp: TC_1.8.6-TestCase_ThreeSocketsOpenSend1KTime")
        print("===================================================")
    ...
    def runTest(self):
        print("=================================================")
        print("Run: TC_1.8.6-TestCase_ThreeSocketsOpenSend1KTime")
        print("=================================================")
        ...
        #Send UDP data to DUT for 300 times
        self.udpTests.sendUdpData("COSP_RX",300)
        
        result = self.testSection.waitForReports([self.TP1], 6000)
    ...
    def tearDown(self):
        print("======================================================")
        print("TearDown: TC_1.8.6-TestCase_ThreeSocketsOpenSend1KTime")
        print("======================================================")
