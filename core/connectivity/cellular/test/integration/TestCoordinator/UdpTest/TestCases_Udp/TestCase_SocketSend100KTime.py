...
class TestCase_SocketSend100KTime(unittest.TestCase):
    ...
    def __init__(self, testSection, testSuite):
        super(TestCase_SocketSend100KTime, self).__init__()
    ...
    def setUp(self):
        print("============================================")
        print("setUp: TC_1.8.4-TestCase_SocketSend100KTime ")
        print("============================================")
    ...
    def runTest(self):
        print("==========================================")
        print("Run: TC_1.8.4-TestCase_SocketSend100KTime ")
        print("==========================================")
        ...
        result = self.testSection.waitForReports([self.TP1], 5600)
    ...
    def tearDown(self):
        print("===============================================")
        print("TearDown: TC_1.8.4-TestCase_SocketSend100KTime ")
        print("===============================================")
