...
class TestCase_SocketReceiveAfter4MinDelay(unittest.TestCase):
    ...
    def __init__(self, testSection, testSuite):
        super(TestCase_SocketReceiveAfter4MinDelay, self).__init__()
    ...
    def setUp(self):
        print("=====================================================")
        print("setUp: TC_1.8.2-TestCase_SocketReceiveAfter4MinDelay ")
        print("=====================================================")
    ...
    def runTest(self):
        print("===================================================")
        print("Run: TC_1.8.2-TestCase_SocketReceiveAfter4MinDelay ")
        print("===================================================")
        ...
        #Send UDP data to DUT after 4 minutes
        self.udpTests.waitAndSendUdpData(240,"COSP_RX after delay of 4 minutes")

        result = self.testSection.waitForReports([self.TP1], 260)
        ...
        if(NO_ERROR == report1.getErrorCode()):
            print("After 4 min of delay, the data sent by server is not received by device")

    def tearDown(self):
        print("========================================================")
        print("TearDown: TC_1.8.2-TestCase_SocketReceiveAfter4MinDelay ")
        print("========================================================")
