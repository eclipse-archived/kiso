...
class TestCase_Configure(unittest.TestCase):

    testCaseId = 4

    def __init__(self, testSection, testSuite):
        super(TestCase_Configure, self).__init__()
    ...
    def setUp(self):
        print("=====================================")
        print("SetUp: TC_1.6.4-TestCase_Configure  ")
        print("=====================================")
    ...
    def runTest(self):
        print("==================================")
        print("Run: TC_1.6.4-TestCase_Configure ")
        print("==================================")
    ...
    def tearDown(self):
        print("======================================")
        print("TearDown: TC_1.6.4-TestCase_Configure")
        print("======================================")
