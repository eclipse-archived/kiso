...
class TestCase_LoadSocketOpenClose(unittest.TestCase):

    testCaseId = 6

    def __init__(self, testSection, testSuite):
        super(TestCase_LoadSocketOpenClose, self).__init__()
    ...
    def setUp(self):
        print("==============================")
        print("setUp TC_1.6.7: TestCase_LoadSocketOpenClose ")
        print("==============================")
    ...
    def runTest(self):
        print("==============================")
        print("Run TC_1.6.7: TestCase_SocketOpenClose ")
        print("==============================")
    ...
    def tearDown(self):
        print("==============================")
        print("TearDown: TestCase_SocketOpenClose ")
        print("==============================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
