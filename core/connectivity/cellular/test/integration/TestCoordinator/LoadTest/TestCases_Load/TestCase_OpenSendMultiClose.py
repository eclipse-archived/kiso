...
class TestCase_OpenSendMultiClose(unittest.TestCase):

    testCaseId = 9

    def __init__(self, testSection, testSuite):
        super(TestCase_OpenSendMultiClose, self).__init__()
    ...
    def setUp(self):
        print("===================================")
        print("setUp 1.6.9: TestCase_OpenSendMultiClose ")
        print("===================================")
    ...
    def runTest(self):
        print("=================================")
        print("Run 1.6.9: TestCase_OpenSendMultiClose ")
        print("=================================")
    ...
    def tearDown(self):
        print("======================================")
        print("TearDown 1.6.9: TestCase_OpenSendMultiClose ")
        print("======================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
