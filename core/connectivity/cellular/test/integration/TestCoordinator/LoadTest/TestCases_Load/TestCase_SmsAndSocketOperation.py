...
class TestCase_SmsAndSocketOperation(unittest.TestCase):

    testCaseId = 14
    def __init__(self, testSection, testSuite):
        super(TestCase_SmsAndSocketOperation, self).__init__()
    ...
    def setUp(self):
        print("=============================================")
        print("setUp 1.6.14: TestCase_SmsAndSocketOperation ")
        print("=============================================")
    ...
    def runTest(self):
        print("===========================================")
        print("Run 1.6.14: TestCase_SmsAndSocketOperation ")
        print("===========================================")
        ...
        result = self.testSection.waitForReports([self.TP1], 600)
    ...
    def tearDown(self):
        print("================================================")
        print("TearDown 1.6.14: TestCase_SmsAndSocketOperation ")
        print("=================================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
