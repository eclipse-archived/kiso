...
class TestCase_ConnectDisconnect(unittest.TestCase):

    testCaseId = 5

    def __init__(self, testSection, testSuite):
        super(TestCase_ConnectDisconnect, self).__init__()
    ...
    def setUp(self):
        print("==================================")
        print("SetUp: TC_1.6.5-TestCase_ConnectDisconnect  ")
        print("==================================")
    ...
    def runTest(self):
        print("===============================")
        print("Run: TC_1.6.5-TestCase_ConnectDisconnect ")
        print("===============================")
        ...
        result = self.testSection.waitForReports([self.TP1], 7000)
    ...
    def tearDown(self):
        print("===================================")
        print("TearDown: TC_1.6.5-TestCase_ConnectDisconnect")
        print("===================================")
