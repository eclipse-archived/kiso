...
class TestCase_OpenSendCloseSimul(unittest.TestCase):

    testCaseId = 11

    def __init__(self, testSection, testSuite):
        super(TestCase_OpenSendCloseSimul, self).__init__()
    ...
    def setUp(self):
        print("==========================================")
        print("setUp 1.6.11: TestCase_OpenSendCloseSimultaneous ")
        print("==========================================")
    ...
    def runTest(self):
        print("========================================")
        print("Run 1.6.11: TestCase_OpenSendCloseSimultaneous ")
        print("========================================")
    ...
    def tearDown(self):
        print("=============================================")
        print("TearDown 1.6.11: TestCase_OpenSendCloseSimultaneous ")
        print("=============================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
