...
class TestCase_OpenSendThreeThenClose(unittest.TestCase):

    testCaseId = 10

    def __init__(self, testSection, testSuite):
        super(TestCase_OpenSendThreeThenClose, self).__init__()
    ...
    def setUp(self):
        print("=======================================")
        print("setUp 1.6.10: TestCase_OpenSendThreeThenClose ")
        print("=======================================")
    ...
    def runTest(self):
        print("=====================================")
        print("Run 1.6.10: TestCase_OpenSendThreeThenClose ")
        print("=====================================")
        ...
        result = self.testSection.waitForReports([self.TP1], 20000)
    ...
    def tearDown(self):
        print("==========================================")
        print("TearDown 1.6.10: TestCase_OpenSendThreeThenClose ")
        print("==========================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
        ...
        ack = self.TP1.sendAndWaitForAck(message, 80)
        self.assertEqual(NO_ERROR, ack.getErrorCode(), "we don't expect any error code")
