...
class TestCase_SendDataEvery20Sec(unittest.TestCase):

    testCaseId = 13

    def __init__(self, testSection, testSuite):
        super(TestCase_SendDataEvery20Sec, self).__init__()
    ...
    def setUp(self):
        print("====================================")
        print("setUp: TestCase_SendDataEvery20Sec ")
        print("====================================")
    ...
    def runTest(self):
        print("==================================")
        print("Run: TestCase_SendDataEvery20Sec ")
        print("==================================")
        ...
        result = self.testSection.waitForReports([self.TP1], 13500)
    ...
    def tearDown(self):
        print("=======================================")
        print("TearDown: TestCase_SendDataEvery20Sec ")
        print("=======================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
