...
class TestCase_Reset(unittest.TestCase):

    testCaseId = 2

    def __init__(self, testSection, testSuite):
        super(TestCase_Reset, self).__init__()
    ...
    def setUp(self):
        print("================================")
        print("SetUp: TC_1.6.2-TestCase_Reset  ")
        print("================================")
    ...
    def runTest(self):
        print("=============================")
        print("Run: TC_1.6.2-TestCase_Reset ")
        print("=============================")
    ...
    def tearDown(self):
        print("=================================")
        print("TearDown: TC_1.6.2-TestCase_Reset")
        print("=================================")
