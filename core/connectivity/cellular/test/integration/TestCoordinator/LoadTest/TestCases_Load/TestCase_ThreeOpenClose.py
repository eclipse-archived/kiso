...
class TestCase_ThreeOpenClose(unittest.TestCase):

    testCaseId = 8

    def __init__(self, testSection, testSuite):
        super(TestCase_ThreeOpenClose, self).__init__()
    ...
    def setUp(self):
        print("====================================")
        print("setUp 1.6.8: TestCase_LoadSocketOpenClose ")
        print("====================================")
    ...
    def runTest(self):
        print("================================")
        print("Run 1.6.8: TestCase_ThreeOpenClose.py ")
        print("================================")
    ...
    def tearDown(self):
        print("==================================")
        print("TearDown 1.6.8: TestCase_ThreeOpenClose ")
        print("==================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
