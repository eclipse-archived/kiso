...
class TestCase_SocketOperation(unittest.TestCase):

    testCaseId = 12

    def __init__(self, testSection, testSuite):
        super(TestCase_SocketOperation, self).__init__()
    ...
    def setUp(self):
        print("==============================")
        print("setUp 1.6.12: TestCase_SocketOperation ")
        print("==============================")
    ...
    def runTest(self):
        print("==============================")
        print("Run 1.6.12: TestCase_SocketOperation ")
        print("==============================")
    ...
    def tearDown(self):
        print("==============================")
        print("TearDown 1.6.12: TestCase_SocketOperation ")
        print("==============================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
