...
class TestCase_PowerOn(unittest.TestCase):

    testCaseId = 1

    def __init__(self, testSection, testSuite):
        super(TestCase_PowerOn, self).__init__()
    ...
    def setUp(self):
        print("==================================")
        print("SetUp: TC_1.6.1-TestCase_PowerOn  ")
        print("==================================")
        ...
        ack = self.TP1.sendAndWaitForAck(message, 30)
        self.assertEqual(NO_ERROR, ack.getErrorCode(), "we don't expect any error code")

    def runTest(self):
        print("===============================")
        print("Run: TC_1.6.1-TestCase_PowerOn ")
        print("===============================")
    ...
    def tearDown(self):
        print("===================================")
        print("TearDown: TC_1.6.1-TestCase_PowerOn")
        print("===================================")
