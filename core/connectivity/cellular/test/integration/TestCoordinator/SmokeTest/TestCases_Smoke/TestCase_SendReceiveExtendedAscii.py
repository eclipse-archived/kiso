...
class TestCase_SendReceiveExtendedAscii(unittest.TestCase):

    testCaseId = 6

    def __init__(self, testSection, testSuite):
        super(TestCase_SendReceiveExtendedAscii, self).__init__()
    ...
    def setUp(self):
        print("===================================================")
        print("setUp: TC_1.9.6-TestCase_SendReceiveExtendedAscii  ")
        print("===================================================")
    ...
    def runTest(self):
        print("=================================================")
        print("Run: TC_1.9.6-TestCase_SendReceiveExtendedAscii  ")
        print("=================================================")
        ...
        result = self.testSection.waitForReports([self.TP1], 2000)
    ...
    def tearDown(self):
        print("======================================================")
        print("TearDown: TC_1.9.6-TestCase_SendReceiveExtendedAscii  ")
        print("======================================================")
