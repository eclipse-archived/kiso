...
class TestCase_OnOff(unittest.TestCase):

    testCaseId = 1

    def __init__(self, testSection, testSuite):
        super(TestCase_OnOff, self).__init__()
    ...
    def tearDown(self):
        ...
        ack = self.TP1.sendAndWaitForAck(message, 50)
        self.assertEqual(NO_ERROR, ack.getErrorCode(), "we don't expect any error code")
