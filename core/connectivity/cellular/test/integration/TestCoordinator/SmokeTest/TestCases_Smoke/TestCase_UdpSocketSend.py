...
class TestCase_UdpSocketSend(unittest.TestCase):

    testCaseId = 4

    def __init__(self, testSection, testSuite):
        super(TestCase_UdpSocketSend, self).__init__()
    ...
    def setUp(self):
        print("==============================")
        print("setUp: TestCase_UdpSocketSend ")
        print("==============================")
        ...
        ack = self.TP1.sendAndWaitForAck(message, 100)
        self.assertEqual(NO_ERROR, ack.getErrorCode(), "we don't expect any error code")

    def runTest(self):
        print("==============================")
        print("Run: TestCase_UdpSocketSend ")
        print("==============================")
        ...
        result = self.testSection.waitForReports([self.TP1], 120)
    ...
    def tearDown(self):
        print("==============================")
        print("TearDown: TestCase_UdpSocketSend ")
        print("==============================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
