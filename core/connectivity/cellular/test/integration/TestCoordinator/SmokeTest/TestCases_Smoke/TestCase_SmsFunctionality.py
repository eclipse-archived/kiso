...
class TestCase_SmsFunctionality(unittest.TestCase):

    testCaseId = 5

    def __init__(self, testSection, testSuite):
        super(TestCase_SmsFunctionality, self).__init__()
    ...
    def setUp(self):
        print("=================================")
        print("setUp: TestCase_SmsFunctionality ")
        print("=================================")
    ...
    def runTest(self):
        print("===============================")
        print("Run: TestCase_SmsFunctionality ")
        print("===============================")
    ...
    def tearDown(self):
        print("====================================")
        print("TearDown: TestCase_SmsFunctionality ")
        print("====================================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(),
