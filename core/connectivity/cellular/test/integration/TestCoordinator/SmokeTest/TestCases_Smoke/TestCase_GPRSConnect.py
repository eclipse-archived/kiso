...
class TestCase_GPRSConnect(unittest.TestCase):

    testCaseId = 3

    def __init__(self, testSection, testSuite):
        super(TestCase_GPRSConnect, self).__init__()
    ...
    def setUp(self):
        print("==============================")
        print("setUp: TestCase_GPRSConnect ")
        print("==============================")
    ...
    def runTest(self):
        print("==============================")
        print("Run: TestCase_GPRSConnect ")
        print("==============================")
        ...
        messageTP1.addTLVElement(TestCaseRun,CONFIG_APN)
        messageTP1.addTLVElement(TestCaseRun,CONFIG_USERNAME)
        messageTP1.addTLVElement(TestCaseRun,CONFIG_PASSWORD)
        
        ack = self.TP1.sendAndWaitForAck(messageTP1, TIMEOUT)
        self.assertEqual(NO_ERROR, ack.getErrorCode(), "we don't expect any error code")

        result = self.testSection.waitForReports([self.TP1], 160)
    ...
    def tearDown(self):
        print("==============================")
        print("TearDown: TestCase_GPRSConnect ")
        print("==============================")
        message = Message(msgType=COMMAND, msgToken=self.testSection.getMsgToken(), 
