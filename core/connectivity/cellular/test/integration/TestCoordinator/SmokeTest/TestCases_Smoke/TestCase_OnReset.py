...
class TestCase_OnReset(unittest.TestCase):

    testCaseId = 2

    def __init__(self, testSection, testSuite):
        super(TestCase_OnReset, self).__init__()
    ...
    def runTest(self):
        ...
        result = self.testSection.waitForReports([self.TP1], 80)
    ...
    def tearDown(self):
        print("==============================")
        print("TearDown: TestCase_OnReset ")
        print("==============================")
