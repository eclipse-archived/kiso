...
/**
 * @deprecated since version vxx.xx.xx, replaced by #GuardedTask_Initialize
...
/**
 * @deprecated since version vxx.xx.xx, replaced by #GuardedTask_Deinitialize
 * @todo replace vxx.xx.xx with next version
 *
 *  @brief  This function deinitializes a given GuardTask handle and sets all attributes to NULL.
 *
...
/**
 * @deprecated since version vxx.xx.xx, replaced by #GuardedTask_Signal
 * @todo replace vxx.xx.xx with next version
 *
 * @brief  This function signals the GuardTask-task to execute its user run function
 *
 ...
 *  @retval #RETCODE_INVALID_PARAM                       -   Given parameter was invalid
 */
BCDS_DEPRECATED(Retcode_T GuardedTask_signal(GuardedTask_T* handle));

/**
 * @deprecated since version vxx.xx.xx, replaced by #GuardedTask_SignalFromIsr
 * @todo replace vxx.xx.xx with next version
 *
 * @brief  This function signals the GuardTask-task to execute its user run function
 *
 ...
 *  @retval #RETCODE_INVALID_PARAM                       -   Given parameter was invalid
 */
BCDS_DEPRECATED(Retcode_T GuardedTask_signalFromIsr(GuardedTask_T* handle));
