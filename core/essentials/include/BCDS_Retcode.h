 ...
 *              and code are passed as parameters, the package and module are taken from the macro BCDS_PACKAGE_ID
 *              and BCDS_MODULE_ID, which must be defined in each package / module.
 *
