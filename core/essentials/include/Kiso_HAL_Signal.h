...
#ifndef KISO_HAL_SIGNAL_H_
#define KISO_HAL_SIGNAL_H_
 ...
 */
#define KISO_HAL_SIGNAL_WAITFOREVER 0
 ...
 *              - The value KISO_HAL_SIGNAL_WAITFOREVER sets no Timeout i.e. waits for ever.
 *
 * @retval      #RETCODE_OK when successful
 *
