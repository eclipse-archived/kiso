...
/**
 * @file
 * @defgroup    BCDS_HAL_MCU_FLASH_INTERN  MCU Internal Flash
...
#ifndef BCDS_MCU_FLASH_INTERN_H_
#define BCDS_MCU_FLASH_INTERN_H_
...
{
    enum BCDS_HAL_CallMode_E CallMode; /**< Blocking or interrupt mode selection for the internal flash operations. */
...
#endif /* BCDS_MCU_FLASH_INTERN_H_ */
