...
/**
 * @file
 * @defgroup    KISO_HAL_MCU_I2C MCU I2C
 ...
 * will only be compiled and linked if the feature <b>KISO_FEATURE_I2C</b> is set to 1 in the configuration file.
 *
 ...
 */
#ifndef KISO_MCU_I2C_H
#define KISO_MCU_I2C_H
