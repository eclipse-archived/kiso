...
/**
 * @file
 * @defgroup BCDS_HAL_MCU_TIMER MCU Timer
 ...
 * only be compiled and linked if the feature <b>BCDS_FEATURE_TIMER</b> is set to 1 in the configuration file.
 */
