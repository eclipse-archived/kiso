...
/**
 * @file
 * @defgroup    BCDS_HAL_MCU_FLASH MCU Flash
 ...
 * code will only be compiled and linked if the feature <b>BCDS_FEATURE_FLASH</b> is set to 1 in the configuration file.
 * @todo        Deprecate this API as it does not fulfill microcontroller portability criteria use
 * BCDS_MCU_FlashIntern.h instead.
 */
