...
from TestSuite_I2C.TestCase_1_a import *



class TestSuite_I2C(abstract_test_suite.AbstractTestSuite):
    ...
    def setUp(self):
        ...
        generic_test_case_dict = {'test_case_name': 'Test Case I2C', 'test_case_id': 1,
        ...
        self.generic_setUp()
        #self.add_test_case(TestCase_1_a)
