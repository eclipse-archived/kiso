...
from TestSuite_UART.test_duration import test_durations


class TestCase_3_a(abstract_test_case.AbstractTestCase):
    test_case_id = 1

    def setUp(self):
        print("==============================")
        print("SetUp: TestCase_SPI ")
        print("==============================")
