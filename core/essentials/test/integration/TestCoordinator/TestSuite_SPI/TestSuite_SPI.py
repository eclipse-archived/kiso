...
from TestSuite_SPI.TestCase_2_a import *



class TestSuite_SPI(abstract_test_suite.AbstractTestSuite):
    ...
    def setUp(self):
        ...
        generic_test_case_dict = {'test_case_name': 'Test Case SPI', 'test_case_id': 1,
