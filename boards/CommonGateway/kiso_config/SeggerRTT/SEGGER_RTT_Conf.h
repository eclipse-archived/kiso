...
*/
#include "FreeRTOS.h"
#define SEGGER_RTT_MAX_NUM_UP_BUFFERS             (2u)     // Max. number of up-buffers (T->H) available on this target    (Default: 2)
#define SEGGER_RTT_MAX_NUM_DOWN_BUFFERS           (2u)     // Max. number of down-buffers (H->T) available on this target  (Default: 2)

#define BUFFER_SIZE_UP                            (2048u)  // Size of the buffer for terminal output of target, up to host (Default: 1k)
#define BUFFER_SIZE_DOWN                          (2048u)  // Size of the buffer for terminal input to target from host (Usually keyboard input) (Default: 16)
