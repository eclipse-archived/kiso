...
#ifndef MBEDTLS_CONFIG_DTLS_H
#define MBEDTLS_CONFIG_DTLS_H
...
//#endif /* #if SERVAL_ENABLE_TLS && SERVAL_TLS_MBEDTLS */
 ...
 */
#define MBEDTLS_SSL_MAX_CONTENT_LEN             900 /* Used for DTLS */
