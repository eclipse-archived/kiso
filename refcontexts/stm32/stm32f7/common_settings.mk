...
export BCDS_ARCH_CPU = ARM_CM7F
export BCDS_MCU_FAMILY ?= stm32f7
export BCDS_STM32_DEVICE_TYPE ?= STM32F7xx
export BCDS_STM32_DEVICE_ID ?= STM32F767ZI
export BCDS_STM32_DEVICE_PACKAGE_TYPE ?= STM32F767xx
...
BCDS_CONFIG_PATH = $(BCDS_SHARED_PATH)/RefContexts/stm32/stm32f7/config

# The absolute path to the BSP implementation folder. 
BCDS_BOARD_PATH = $(BCDS_SHARED_PATH)/RefContexts/stm32/stm32f7/BSP
...
BCDS_MACROS_DEBUG ?= \
	...
	-D $(BCDS_STM32_DEVICE_PACKAGE_TYPE) -D GCC_ARMCM7 -D USE_HAL_DRIVER=1
