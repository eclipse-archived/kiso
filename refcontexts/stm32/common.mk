...
# Set the default STM32 family if none was provided. As initial development was
# conducted for STM32L4, it was deciced that this will be the default variant. 
ifeq ($(BCDS_MCU_FAMILY),)
	export BCDS_MCU_FAMILY ?= stm32l4
endif

include $(dir $(BCDS_COMMON_MAKEFILE))$(BCDS_MCU_FAMILY)/common_settings.mk
...
.PHONY: check
check::
ifneq ($(BCDS_TARGET_PLATFORM),stm32)
	$(error Mismatch of target platformm, BCDS_TARGET_PLATFORM is $(BCDS_TARGET_PLATFORM) instead of stm32)
endif
...
diagnosis::
	...
	@echo "BCDS_MCU_FAMILY:      "$(BCDS_MCU_FAMILY)
