...
BCDS_GTEST_CODE_PATH = $(BCDS_PACKAGE_HOME)/test/unit
...
CXXFLAGS = -O0 -g3 -static -Wall -Wextra -Winvalid-pch -Wswitch-default -fno-exceptions -DARM_MATH_CM0_FAMILY
...
$(BCDS_GTEST_OUTPUT_PATH)/%_unittest.o: $(BCDS_PACKAGE_HOME)/%_unittest.cc
	@mkdir -p $(@D)
