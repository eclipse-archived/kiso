 ...
 *  encrypted form.
 *
 *  @file        UPA_userPageAccess_ph.h
 *
 *  Configuration header for the UPA_userPageAccess module.
 *  @note: 1) Size of the structure should be defined based on its element's size
 *         2) Application specific Union is necessary and this ph file is an example
