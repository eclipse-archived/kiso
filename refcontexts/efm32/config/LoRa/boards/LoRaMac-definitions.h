 ...
 * Maximal datarate that can be used by the node
 */
#define LORAMAC_TX_MAX_DATARATE                     DR_3

/*!
 * Minimal datarate that can be used by the node
 */
#define LORAMAC_RX_MIN_DATARATE                     DR_6
 ...
 */
// Channel = { Frequency [Hz], Datarate }
#define RX_WND_2_CHANNEL                                  { 869525000, DR_6 }
 ...
 * Minimal datarate that can be used by the node
 */
#define LORAMAC_MIN_DATARATE                        DR_3

/*!
 * Minimal datarate that can be used by the node
 */
#define LORAMAC_MAX_DATARATE                        DR_3

/*!
 * LoRaMac default channels
 */
// Channel = { Frequency [Hz], { ( ( DrMax << 4 ) | DrMin ) }, Band }
#define LC1                { 868100000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 1 }
#define LC2                { 868300000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 1 }
#define LC3                { 868500000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 1 }
#define LC4                { 868800000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 2 }
#define LC5                { 867300000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 0 }
#define LC6                { 867500000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 0 }
// next two are same as LC3, remove?
#define LC7                { 867700000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 0 }
#define LC8                { 867900000, { ( ( LORAMAC_MAX_DATARATE << 4 )  | LORAMAC_MIN_DATARATE ) }, 0 }

/* Mode FSK is not needed for APLM so it commented
#define LC9                { 868300000, { ( ( DR_6 << 4 )  | DR_4  ) }, 1 }
*/
