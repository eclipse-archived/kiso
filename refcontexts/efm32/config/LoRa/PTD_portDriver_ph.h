 ...
 *  encrypted form.
 *
 *  @file        PTD_portDriver_ph.h
 *
 * This file consist of all the peripherals  related macro , which will help
 * the user to configure the peripherals based on the hardware.
 *
 * ****************************************************************************/
