    ...
    switch (id)
    {
        case (BSP_XDK_SENSOR_BMA280):
            if (BSP_I2C0.Peripheral.Sensor_BMA280 == 0)
            {
                ...
                BoardCommon_Delay(BMA280_STARTUP_DELAY);
                ...
                if (BSP_XDK_SENSOR_BMA280_ENABLE_INTERRUPT)
                {
                    ...
                    else if ((0 == BSP_XDK_SENSOR_BMA280_FORCE_INTERRUPT) && (NULL != BoardCommon_GPIOInterruptGetCallback(BMA280_INT2_PIN)))
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(BMA280_INT1_PIN, BMA280_INT_InterruptCallback);
                    ...
                    else
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(BMA280_INT1_PIN, BMA280_INT_InterruptCallback);
                        BoardCommon_GPIOInterruptRegisterCallback(BMA280_INT2_PIN, BMA280_INT2_InterruptCallback);
        ...
        case (BSP_XDK_SENSOR_BMG160):
            if (BSP_I2C0.Peripheral.Sensor_BMG160 == 0)
            {
                ...
                BoardCommon_Delay(BMG160_STARTUP_DELAY);
                ...
                if (BSP_XDK_SENSOR_BMG160_ENABLE_INTERRUPT)
                {
                    ...
                    else
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(BMG160_INT1_PIN, BMG160_INT1_InterruptCallback);
                        BoardCommon_GPIOInterruptRegisterCallback(BMG160_INT2_PIN, BMG160_INT2_InterruptCallback);
        ...
        case (BSP_XDK_SENSOR_BME280):
            if (BSP_I2C0.Peripheral.Sensor_BME280 == 0)
            {
                ...
                BoardCommon_Delay(BME280_STARTUP_DELAY);
        ...
        case (BSP_XDK_SENSOR_BMM150):
            if (BSP_I2C0.Peripheral.Sensor_BMM150 == 0)
            {
                ...
                BoardCommon_Delay(BMM150_STARTUP_DELAY);
                ...
                if (BSP_XDK_SENSOR_BMM150_ENABLE_INTERRUPT)
                {
                    ...
                    else if ((0 == BSP_XDK_SENSOR_BMM150_FORCE_INTERRUPT) && (NULL != BoardCommon_GPIOInterruptGetCallback(BMM150_INT_PIN)))
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(BMM150_DRDY_PIN, BMM150_DRDY_InterruptCallback);
                    ...
                    else
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(BMM150_INT_PIN, BMM150_INT_InterruptCallback);
                        BoardCommon_GPIOInterruptRegisterCallback(BMM150_DRDY_PIN, BMM150_DRDY_InterruptCallback);
        ...
        case (BSP_XDK_SENSOR_MAX44009):
            if (BSP_I2C0.Peripheral.Sensor_MAX44009 == 0)
            {
                ...
                BoardCommon_Delay(MAX44009_STARTUP_DELAY);
                ...
                if (BSP_XDK_SENSOR_MAX44009_ENABLE_INTERRUPT)
                {
                    ...
                    else
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(MAX44009_INTN_PIN, MAX44009_INTN_InterruptCallback);
        ...
        case (BSP_XDK_SENSOR_BMI160):
            if (BSP_I2C0.Peripheral.Sensor_BMI160 == 0)
            {
                ...
                BoardCommon_Delay(BMI160_STARTUP_DELAY);
                ...
                if (BSP_XDK_SENSOR_BMI160_ENABLE_INTERRUPT)
                {
                    ...
                    else if ((false == BSP_XDK_SENSOR_BMI160_FORCE_INTERRUPT) && (NULL != BoardCommon_GPIOInterruptGetCallback(BMI160_INT2_PIN)))
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(BMI160_INT1_PIN, BMI160_INT1_InterruptCallback);
                    ...
                    else
                    {
                        ...
                        BoardCommon_GPIOInterruptRegisterCallback(BMI160_INT1_PIN, BMI160_INT1_InterruptCallback);
                        BoardCommon_GPIOInterruptRegisterCallback(BMI160_INT2_PIN, BMI160_INT2_InterruptCallback);
    ...
    switch (id)
    {
        case (BSP_XDK_SENSOR_BMA280):
            ...
            if (SensorsFlags.BMA280UsesINT1)
            {
                ...
                BoardCommon_GPIOInterruptUnregisterCallback(BMA280_INT1_PIN);
            ...
            if (SensorsFlags.BMA280UsesINT2)
            {
                ...
                SensorNode_BMA280ISRCallback = NULL;
                BoardCommon_GPIOInterruptUnregisterCallback(BMA280_INT2_PIN);
        ...
        case (BSP_XDK_SENSOR_BMG160):
            ...
            if (SensorsFlags.BMG160UsesINT1)
            {
                ...
                BoardCommon_GPIOInterruptUnregisterCallback(BMG160_INT1_PIN);
            ...
            if (SensorsFlags.BMG160UsesINT2)
            {
                ...
                SensorNode_BMG160ISRCallback = NULL;
                BoardCommon_GPIOInterruptUnregisterCallback(BMG160_INT2_PIN);
        ...
        case (BSP_XDK_SENSOR_BMM150):
            ...
            if (SensorsFlags.BMM150UsesINT)
            {
                ...
                BoardCommon_GPIOInterruptUnregisterCallback(BMM150_INT_PIN);
            ...
            if (SensorsFlags.BMM150UsesDRDY)
            {
                ...
                SensorNode_BMM150ISRCallback = NULL;
                BoardCommon_GPIOInterruptUnregisterCallback(BMM150_DRDY_PIN);
        ...
        case (BSP_XDK_SENSOR_MAX44009):
            ...
            if (SensorsFlags.MAX44009UsesINTN)
            {
                ...
                BoardCommon_GPIOInterruptUnregisterCallback(MAX44009_INTN_PIN);
        ...
        case (BSP_XDK_SENSOR_BMI160):
            ...
            {
                SensorNode_BMI160ISRCallback = NULL;
                BoardCommon_GPIOInterruptUnregisterCallback(BMI160_INT2_PIN);
