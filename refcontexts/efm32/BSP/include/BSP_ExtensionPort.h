 ...
 * BSP_EXTENSIONPORT_PUSHPULL                   | (X) - Dont care,set initial Output pin value to either BSP_EXTENSIONPORT_GPIO_PIN_HIGH or BSP_EXTENSIONPORT_GPIO_PIN_LOW based on application need|
 * BSP_EXTENSIONPORT_OPEN_SOURCE                | (X) - Dont care,Check for presence of external Pull-down in Interfacing HW circuitry if not set initial Output pin value to BSP_EXTENSIONPORT_GPIO_PIN_LOW for safer side|
 * BSP_EXTENSIONPORT_OPEN_SOURCEPULLDOWN        | (X) - Dont care, set value default value as BSP_EXTENSIONPORT_GPIO_PIN_LOW for safer side
 * BSP_EXTENSIONPORT_OPEN_DRAIN                 | (X) - Dont care, Check for presence of external Pull-up in Interfacing HW circuitry, if not set initial Output pin value to set value BSP_EXTENSIONPORT_GPIO_PIN_HIGH for safer side|
 * BSP_EXTENSIONPORT_OPEN_DRAINFILTER           | (X) - Dont care, set value default value as BSP_EXTENSIONPORT_GPIO_PIN_HIGH for safer side                                              |
 * BSP_EXTENSIONPORT_OPEN_DRAINPULLUP           | (X) - Dont care, set value default value as BSP_EXTENSIONPORT_GPIO_PIN_HIGH for safer side , this enables internal pull up on this output pin
 * BSP_EXTENSIONPORT_OPEN_DRAINPULLUP_FILTER    | (X) - Dont care, set value default value as BSP_EXTENSIONPORT_GPIO_PIN_HIGH for safer side , this enables internal pull up on this output pin and also enables input filter
 *
 */
...
{
    BSP_EXTENSIONPORT_UART_STOPBITS_HALF, /**< 0.5 stopbits. */
    BSP_EXTENSIONPORT_UART_STOPBITS_ONE, /**< 1 stopbits. */
    BSP_EXTENSIONPORT_UART_STOPBITS_ONEANDAHALF, /**< 1.5 stopbits. */
    BSP_EXTENSIONPORT_UART_STOPBITS_TWO, /**< 2 stopbits. */
};
