...
BCDS_SHARED_PATH ?= $(dir $(BCDS_COMMON_MAKEFILE))/../..

# The absolute path to the libraries folder. 
THIRD_PARTY_SHARED_PATH ?= $(BCDS_SHARED_PATH)/thirdparty
...
BCDS_CONFIG_PATH = $(BCDS_SHARED_PATH)/RefContexts/efm32/config

# The absolute path to the BSP implementation folder. 
BCDS_BOARD_PATH = $(BCDS_SHARED_PATH)/RefContexts/efm32/BSP

# The absolute path to the common gtest makefile
BCDS_COMMON_GTEST_MAKEFILE = $(dir $(BCDS_COMMON_MAKEFILE))/common_gtest.mk
