...
FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Master_Seq_Transmit_IT, I2C_HandleTypeDef *, uint16_t, uint8_t *, uint16_t, uint32_t)
FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Master_Seq_Receive_IT, I2C_HandleTypeDef *, uint16_t, uint8_t *, uint16_t, uint32_t)
FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Slave_Seq_Transmit_IT, I2C_HandleTypeDef *, uint8_t *, uint16_t, uint32_t)
FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Slave_Seq_Receive_IT, I2C_HandleTypeDef *, uint8_t *, uint16_t, uint32_t)
