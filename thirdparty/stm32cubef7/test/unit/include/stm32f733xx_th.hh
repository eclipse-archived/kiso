 ...
 * @file
 *
 * Mock-up implementation for the stm32f733xx module.
 */
/*----------------------------------------------------------------------------*/
 
#ifndef STM32F733XX_TH_HH
#define STM32F733XX_TH_HH
...
#undef IS_AES_ALL_INSTANCE
FAKE_VOID_FUNC(IS_AES_ALL_INSTANCE, AES_TypeDef*);
