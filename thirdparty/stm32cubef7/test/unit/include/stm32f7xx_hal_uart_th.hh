 ...
 * @file
 *
 * Mock-up implementation for the stm32f7xx_hal_uart module.
 */
/*----------------------------------------------------------------------------*/
 
#ifndef STM32F7XX_HAL_UART_TH_HH
#define STM32F7XX_HAL_UART_TH_HH
...
#undef __HAL_UART_GET_IT_SOURCE
FAKE_VALUE_FUNC(bool, __HAL_UART_GET_IT_SOURCE, UART_HandleTypeDef*, uint32_t);
...
#undef __HAL_UART_HWCONTROL_RTS_DISABLE
FAKE_VOID_FUNC(__HAL_UART_HWCONTROL_RTS_DISABLE, UART_HandleTypeDef*);
...
# endif /* STM32F7XX_HAL_UART_TH_HH */
