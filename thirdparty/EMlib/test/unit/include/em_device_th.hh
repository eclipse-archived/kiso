 ...
 *
 * This unit test header substitutes "em_device.h"
 *
...
CMU_TypeDef *CMU =(CMU_TypeDef*) malloc(sizeof(CMU_TypeDef));   /**< CMU base pointer */
uint32_t * CMU_BASE = (uint32_t *) CMU;                         /**< CMU base address  */

/* uint32_t cmuAddr; */
/* #define CMU_BASE         						   (&cmuAddr)  */
